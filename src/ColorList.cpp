...
bool ColorList::loadColorsFromFile(const std::string &fileName, const std::string &tag) {
...
std::optional<ColorDef> ColorList::get(const std::string &name) {
    ColorDef result;
    try {
...
SDL_Color ColorList::getSDL_ColorFromCSS_Color(const std::string &input) {
...
bool ColorList::isMultiLine(const std::string &input) {
    if (input.size() < 3)
        return false;
...
std::string ColorList::getColor_Key(const std::string &input) {
    std::string tmp = getEncapsulatedContents(input, '[', ']', 0);
    return getEncapsulatedContents(tmp, '<', '>', 0);
}

std::optional<double> ColorList::getCPS(const std::string &input) {
    double result;
    std::string tmp;
    try {
...
std::optional<ColorDef> ColorList::getColors(const std::string &input) {
